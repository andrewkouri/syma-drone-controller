 ...
 ******************************************************************************
 ...
 Python code in routine_1.py was written to generate the serial strings.
 ...
 Andrew Kouri 01 Jun 2018
 perrytsao on github.com
 andrewkouri on github.com
 *********************************************************************************
...
// supported protocols (stripped all but SYMAX5C1)
enum {
...
uint8_t packet[32];
static bool reset=false; // don't reset upon boot!
...
void loop()
{
    ...
    if (stringComplete) {
        ...
        // process string
        if(inputString.equals("initbind")) {
          Serial.println("re-pairing");
          reset = true;
          inputString = "";
...
void init_protocol()
{
    switch(current_protocol) {
        case PROTO_SYMAX5C1:
            Symax_init();
            SymaX_bind();
            Serial.println("X5c-initialized and bound");
            break;
    }
}
